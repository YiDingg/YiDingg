# Verilog - 0. Preparations

> [!Note|style:callout|label:Infor]
> Initially published by YiDingg at 12:12 on 2025-10-09 in Beijing.
...
我们实际使用的是 iverilog 和 vivado 两种，前者用于常规的简单仿真，后者用于数电实验课的 FPGA 开发板实验。安装教程见下一篇文章 [Verilog - 1. Environment Setup](<Notes/Verilog/Verilog - 1. Environment Setup.md>).
